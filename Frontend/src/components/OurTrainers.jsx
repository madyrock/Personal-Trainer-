  ...
  const trainers = [
    {
      ...
      stats: [
        ...
        { value: 90, label: "Days of a new Superfast Program" },
      ],
...
If you're ready to become the strongest, most mindful version of yourself, I’m here to guide and support you every stretch, squat, and step of the way.`,
    ...
    },
    {
      ...
      price: "Online Rs.499 per session / On-site Rs.999 per session",
      rating: 4.9,
      certificate: "K11 |  CPR | CPT",
      stats: [
        { value: 20, label: "Year of Health Coaching Experience" },
        { value: 25, label: "Contest and Workshop attended" },
        { value: "200+", label: "Happy Customer with Reference" },
        { value: 90, label: "Days of a new Superfast Program" },
      ],
      bio: "Certified Personal Trainer with 20+ years of experience in bodybuilding, strength training, and rehabilitation. Helping you build muscle, recover safely, and achieve real, lasting results.",
      desc: `"Certified Personal Trainer | 20+ Years Experience | Bodybuilding & Rehab Expert"

With over two decades of hands-on experience, I specialize in bodybuilding, strength training, and injury rehabilitation. As a certified trainer, I’ve helped hundreds of clients—from beginners to athletes—transform their bodies, recover safely, and build lasting habits. Whether you're aiming to bulk up, recover from injury, or start fresh with expert guidance, I provide customized training plans tailored to your goals.`,
      images: [
        "/rafiq1.jpg",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Browse our team of certified personal trainers available for online and onsite sessions. Choose the right expert to guide your fitness journey."
        />
        <meta property="og:title" content="Our Trainers | Elite Trainers" />
        <meta
          property="og:description"
          content="Meet our professional trainers and find your perfect fitness coach today."
        />
      </Helmet>
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-2xl uppercase font-extrabold text-center mb-6">
            Choose your trainer
          </p>
